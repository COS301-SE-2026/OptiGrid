...
describe("AddBuildingPage", () => {
  ...
  describe("Initial render", () => {
    ...
    it("defaults building type to 'Commercial'", () => {
      render(<AddBuildingPage />);
      expect(screen.getByRole("combobox", { name: /building type/i })).toHaveTextContent("Commercial");
    });
    ...
    describe("Building type dropdown", () => {
      ...
      types.forEach((type) => {
        it(`renders the ${type} option`, () => {
          ...
          fireEvent.click(screen.getByRole("combobox", { name: /building type/i }));
      ...
      it("updates building type when changed", () => {
        ...
        fireEvent.mouseDown(screen.getByRole("option", { name: "Industrial" }));
        expect(screen.getByRole("combobox", { name: /building type/i })).toHaveTextContent("Industrial");
      });
    });
